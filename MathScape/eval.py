...
os.environ["OPENAI_API_KEY"] = "sk-EQZ9JXfmWa3H53TJi2XFNFUNTPxAI65CQ49PuNipO44nHmzZ"
# openai设置
class openai_config:
    openai_api = os.environ.get('OPENAI_API_ADDR', 'http://123.129.219.111:3000')
...
def openai_chat(messages, model='gpt-3.5-turbo', temperature=1.0, finish_try=3):
...
input_file_nomalize='Math_data/math_with_class.jsonl'

ans_file='parallel_qwen2.5vl_3b_ans.jsonl'
out_file='parallel_qwen2.5vl_3b_ans_with_eval_result.jsonl' 
    ...
    with futures.ThreadPoolExecutor(max_workers=max_workers) as executor:    
            ...
            for i, _ in enumerate(dataset):
                try:
                    ...
                    # 检查 ID 是否存在
                    if id not in id2data_with_class:
                        continue
                    
                    # 检查答案是否存在
                    if key not in id2model_ans:
                        continue
                    
                    model_ans = id2model_ans[key]["ans"]
